<!-- resources/js/components/appointments/ManagerAppointmentFormModal.vue -->
<template>
    <Teleport to="body">
                ...
                <div class="af-modal">
                    ...
                    <div class="af-body">
                        ...
                        <div class="af-section">
                            ...
                            <div v-if="store.loadingSlots" class="af-slots-loading">
                                <span class="af-spinner" /> {{ $t('common.loading') }}
                            </div>
                            <p v-else-if="store.formSlots.length === 0" class="af-hint af-hint--warn">
                        ...
                        <!-- Notas -->
                        <div class="af-section">
                            <label class="af-section__label">{{ $t('appointments.notes') }}</label>
...
async function save() {
    errorMsg.value = ''
    if (!form.value.client_id || !form.value.date || !form.value.start_time) {
